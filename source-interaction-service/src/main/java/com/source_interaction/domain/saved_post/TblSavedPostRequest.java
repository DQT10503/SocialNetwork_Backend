...
public class TblSavedPostRequest {
    @ApiModelProperty(value = "ID user lưu bài đăng")
    private Long userId;
    @ApiModelProperty(value = "ID bài đăng")
    private Long postId;
    @ApiModelProperty(value = "Trạng thái")
    private InteractionStatus status;
    public TblSavedPostRequest() {
    }

    public TblSavedPostRequest(Long userId, Long postId) {
        this.userId = userId;
        this.postId = postId;
    }
    ...
    public String toString() {
        return "TblSavedPostRequest [userId=" + userId + ", postId=" + postId + ", status=" + status + "]";
    }
}
